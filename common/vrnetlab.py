    ...
    def gen_mgmt(self):
        ...
        if 'vEOS-lab' in self.image:
            ...
            res.append(self.nic_type + ",netdev=p%(i)02d,mac=%(mac)s"
                       % { 'i': 0, 'mac': gen_mac(0) })
        res.append("-netdev")
        res.append("user,id=p%(i)02d,net=10.0.0.0/24,tftp=/tftpboot,hostfwd=tcp::2022-10.0.0.15:22,hostfwd=tcp::2023-10.0.0.15:23,hostfwd=udp::2161-10.0.0.15:161,hostfwd=tcp::2830-10.0.0.15:830" % { 'i': 0 })
...
class VR:
    ...
    def start(self):
        ...
        run_command(["socat", "TCP-LISTEN:23,fork", "TCP:127.0.0.1:2023"], background=True)
